      ...
      <table className="table">
        ...
        <tbody>
          {amenidades.map((amenidad, index) => (
            <tr key={index}>
              <td>{amenidad.id}</td>
              <td>{editMode && editedRow === index ? <input type="text" defaultValue={amenidad.costo} /> : amenidad.costo}</td>
              ...
              <td>{editMode && editedRow === index ? <input type="text" defaultValue={amenidad.estado} /> : amenidad.estado}</td>
              <td>
